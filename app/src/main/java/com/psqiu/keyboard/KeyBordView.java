    ...
    class LayoutObserver implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            if (footerView.getHeight() != 0 && headerView.getHeight() != 0 && !init) {
                ...
                keyLayoutParams.width = layoutHeight; // psqiu
...
//                textView.setBackgroundResource(R.drawable.keybord_selector);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.tv_clear) {
            ...
            tv_all.setCompoundDrawables(Utils.getCompoundDrawable(getContext()), null, null, null);
            tv_t9.setCompoundDrawables(null, null, null, null);
            initAll();
        } else if (i == R.id.tv_t9) {
            if (isT9) {
                return;
            }
            tv_t9.setCompoundDrawables(Utils.getCompoundDrawable(getContext()), null, null, null);
    ...
    class KeyPopClick implements OnClickListener, OnFocusChangeListener {
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (hasFocus) {
                if (keySelectIml != null) {
                    if ("退格".equals(((TextView) v).getText().toString().trim())) {
                        keySelectIml.keyDelete(true);
                    } else {
